    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(" 🥀Masuulka ", url=f"https://t.me/ribajosmani"),
                    InlineKeyboardButton("👥 𝙅𝙊𝙄𝙉 𝘿𝙃𝙀𝙃 ", url=f"https://t.me/teamosmani"),
                ],
                [InlineKeyboardButton(text="❌ Close", callback_data="cls")],
            ]
        )
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    await USER.join_chat(invitelink)
                    await USER.send_message(
                        message.chat.id, "waan imid qaraabo hada dalbadaa dooqiina"
                    )
                    await lel.edit(
                        "<b>helper userbot joined your chat</b>",
                    )
...
async def lol_cb(b, cb):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("𝙊𝙒𝙉𝙀𝙍 🥀", url=f"https://t.me/ribajosmani"),
                InlineKeyboardButton("👥 𝙅𝙊𝙄𝙉 𝘿𝙃𝙀𝙃 ", url=f"https://t.me/teamosmani"),
            ],
            [InlineKeyboardButton(text="❌ Close", callback_data="cls")],
        ]
